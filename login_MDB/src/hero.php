      ...
      <div class="wrapper">
        ...
        <div class="cols1">
            <div class="col" ontouchstart="this.classList.toggle('hover');">
              <div class="container">
                <div class="front" style="background-image: url(images/hero1.jpg)">
                    ...
                    <tr>
                        <th style="border-radius: 10px;">Suggested Movies</th>
                          ...
                          <?php
                                ...
                                $sql = "SELECT Movie_name  FROM movies where Hero='Mahesh Babu' ";
            ...
            <div class="col" ontouchstart="this.classList.toggle('hover');">
              ...
              <div class="container">
                <div class="front" style="background-image:url(images/hero2.jpg)">
                  <div class="inner"><br<br><br><br><br><br><br><br><br><br>
                    <span>Nani</span>
                  </div>
                </div>
                    ...
                    <tr>
                        <th style="border-radius: 10px;">Suggested Movies</th>
                          ...
                          <?php
                                ...
                                $sql = "SELECT Movie_name  FROM movies where Hero='Nani' ";
                                $result = $conn->query($sql);
            ...
            <div class="col" ontouchstart="this.classList.toggle('hover');">
              <div class="container">
                <div class="front" style="background-image: url(images/hero4.jpg)">
                  <div class="inner"><br<br><br><br><br><br><br><br><br><br>
                    <span>Prabhas</span>
                  </div>
                </div>
                    ...
                    <tr>
                        <th style="border-radius: 10px;">Suggested Movies</th>
                          ...
                          <?php
                                ...
                                $sql = "SELECT Movie_name  FROM movies where Hero='Prabhas' ";
                                $result = $conn->query($sql);
            ...
            <div class="col" ontouchstart="this.classList.toggle('hover');">
              <div class="container">
                <div class="front" style="background-image: url(images/hero3.jpg)">
                  <div class="inner"><br<br><br><br><br><br><br><br><br><br>
                    <span>Pawan kalyan</span>
                  </div>
                </div>
                <div class="back">
                  <div class="inner">
                  ...
                  <?php
                                ...
                                $sql = "SELECT Movie_name  FROM movies where Hero='Pawan Kalyan' ";
                                $result = $conn->query($sql);
            ...
            <div class="col" ontouchstart="this.classList.toggle('hover');">
              <div class="container">
                <div class="front" style="background-image: url(images/hero5.jpg)">
                  <div class="inner"><br<br><br><br><br><br><br><br><br><br>
                    <span>N T R</span>
                  </div>
                </div>
                <div class="back">
                  ...
                  <?php
                                ...
                                $sql = "SELECT Movie_name  FROM movies where Hero='N.T.R' ";
                                $result = $conn->query($sql);
            ...
            <div class="col" ontouchstart="this.classList.toggle('hover');">
              <div class="container">
                <div class="front" style="background-image: url(images/hero6.jpg)">
                  <div class="inner"><br<br><br><br><br><br><br><br><br><br>
                ...
                <div class="back">
                  ...
                  <?php
                                ...
                                $sql = "SELECT Movie_name  FROM movies where Hero='Ram Charan' ";
                                $result = $conn->query($sql);
